        ...
        <footer className="bg-gray-900 text-gray-300">
            <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white">MedCart</span>
                        </div>
                        <p className="text-sm text-gray-400 mb-6">
                            Your trusted partner for medical education supplies. Serving Nigerian medical students since 2020.
                        </p>
                        <div className="flex gap-3">
                            <Link href="#" className="bg-gray-800 hover:bg-gray-700 rounded-full p-2 transition">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="#" className="hover:text-white transition">Student Discount</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li className="flex items-start gap-2">
                                ...
                                <span>No 4, James Hall, Wuse, Abuja</span>
                            </li>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="flex gap-2">
                                ...
                                <div className="bg-white rounded px-2 py-1">
                                    <span className="text-gray-800 font-bold text-xs">MC</span>
                                </div>
                                <div className="bg-white rounded px-2 py-1">
                                    <span className="text-gray-800 font-bold text-xs">BANK</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-6 text-center text-sm text-gray-400">
                    <p>© 2024 MedCart. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
